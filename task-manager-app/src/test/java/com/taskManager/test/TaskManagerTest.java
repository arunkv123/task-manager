...
public class TaskManagerTest {
	...
	public void performanceTest() {
		...
		ResponseEntity<List> initalList = restTemplate.postForEntity("http://localhost:" + serverPort + "/viewTask",
				request, List.class);
	...
	public void addTaskMockTest() throws Exception {
		...
		this.mockMvc
				.perform(MockMvcRequestBuilders.post("/addTask").contentType(MediaType.APPLICATION_JSON_UTF8_VALUE)
	...
	public void viewTaskMockTest() throws Exception {
		...
		request.setPriorityFrom(0);
		request.setPriorityTo(30);
		ResponseEntity<List> response = restTemplate.postForEntity("http://localhost:" + serverPort + "/viewTask",
				request, List.class);
